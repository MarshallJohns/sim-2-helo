            ...
            <div className='auth'>
                <div className='auth-input'>
                    ...
                    <div className='inputs'>
                        <div>
                            Username:
                            <input onChange={(e) => this.handleChange(e)} name='username' type='text' value={this.state.username} placeholder='Username' />
                        </div>
                        <div>
                            Password:
                            <input onChange={(e) => this.handleChange(e)} name='password' type='text' value={this.state.password} placeholder='Password' />
                        </div>
                    </div>
